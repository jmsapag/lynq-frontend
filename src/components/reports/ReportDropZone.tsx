...
export const ReportDropZone: React.FC<ReportDropZoneProps> = ({
  ...
  const canAccept = !draggedItemType || type === "any" || draggedItemType === type;
  ...
  return (
    <div
      ...
      className={[
        ...
        isEmpty ? "flex items-center justify-center min-h-[120px]" : "border-transparent bg-transparent",
        ...
        !isEmpty && isDraggedOver && canAccept ? "ring-4 ring-green-300/50 ring-offset-2" : "",
        className
      ].join(" ")}
      style={{
      ...
      {isEmpty && (
        <div className="text-center p-4">
          <div className="text-gray-500 text-sm font-medium">
            {title || `Drop ${type === "metric" ? "metric card" : type === "chart" ? "chart widget" : "widget"} here`}
          </div>
          <div className="text-gray-400 text-xs mt-1">
            {type === "metric" ? "Metric widgets display key statistics" : 
             type === "chart" ? "Chart widgets show visual data representations" : 
