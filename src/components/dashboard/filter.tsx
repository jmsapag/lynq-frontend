...
export const DashboardFilters = ({
  ...
  return (
      <div className="bg-white p-4 border border-gray-200 rounded-lg mb-6">
        <div className="flex flex-col sm:flex-row justify-end gap-4 items-start sm:items-center">
          <Menu as="div" className="relative w-full sm:w-64">
            ...
            <Menu.Items className="absolute left-0 z-10 mt-2 w-full max-w-[24rem] origin-top-left bg-white rounded-md border border-gray-200">
              <div className="p-4">
