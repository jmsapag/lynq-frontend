  ...
  const availableItems = [
    {
      ...
      content: { icon: "📊", title: "Analytics" },
    },
    {
      id: "card-1",
      type: "card" as const,
      content: { icon: "📈", title: "Sales Chart" },
    },
    {
      id: "chart-1",
      type: "chart-card" as const,
      content: { icon: "📉", title: "Revenue Graph" },
    },
    {
      id: "small-2",
      type: "small-card" as const,
      content: { icon: "👥", title: "Users" },
    },
    {
      id: "card-2",
      type: "card" as const,
      content: { icon: "🔔", title: "Notifications" },
    },
  ];
              ...
              {availableItems.filter((item) => !isItemDropped(item.id))
                ...
                <div className="text-center text-gray-500 py-8">
                  ...
                  <p className="text-sm mt-1">
                    Drag items here to remove from dashboard
                  </p>
                </div>
              ) : (
                availableItems
