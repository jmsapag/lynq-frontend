...
export default function Droppable({ children, id, acceptedTypes = ['small-card', 'card', 'chart-card'] }: DroppableProps) {
    ...
    const isAccepted = draggedItemType ? acceptedTypes.includes(draggedItemType) : true;
