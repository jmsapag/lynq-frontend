...
1.  En la barra de navegación lateral, haz clic en **"Comparación"** (o el nombre equivalente).
...
3.  **Aplicar Filtros:** Haz clic en "Aplicar" o "Comparar" para generar los gráficos y tablas comparativas.

## Interpretación de Resultados

Los resultados se mostrarán generalmente en forma de:

- **Gráficos Comparativos:** Líneas o barras superpuestas para visualizar fácilmente las diferencias.
- **Tablas Resumen:** Valores totales y promedios para cada elemento comparado, junto con la variación porcentual.

Analiza las diferencias para obtener insights sobre el rendimiento relativo de tus locales o el impacto de tus acciones a lo largo del tiempo.
